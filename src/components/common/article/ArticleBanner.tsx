    ...
    return (
        <div className="relative w-full h-[300px] md:h-[500px] lg:h-[600px] border sm:mt-10 mt-10">
            <div
                ...
                aria-hidden
            />
             {firstBreadcrumb && <div className="absolute mt-11 md:mx-16 inset-0 z-30 mx-0 " >
                <Breadcrumb path={[firstBreadcrumb, title]} isBanner />
            </div>}
            <img
                src={imageUrl}
                alt={title}
                className="absolute left-0 w-screen lg:[700px] md:h-[700px] h-[300px] max-h-[1440px] object-cover object-center filter brightness-75"
            />
            
            <div className="absolute inset-0 bottom-20 flex flex-col items-center justify-end text-white px-6 text-center z-10">
